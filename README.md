...
Developed and integrated customer-facing software using **Java/Spring Boot**, APIs, backend services, and AI-enabled system components.
Worked across cloud services, databases, APIs, edge devices, and application layers to support end-to-end technical solutions.

I am **AWS Certified Cloud Practitioner** and continue to deepen my cloud architecture knowledge with a focus on production AI/ML systems.
